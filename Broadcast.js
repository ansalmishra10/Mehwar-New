...
class Broadcast extends Component<Props> {
    state = {
        peerIds: [],
        joinSucceed: false,
        isMute: false,
    ...
    componentWillMount () {
    //   this.listener = EventRegister.addEventListeners('myCustomEvents', (data) => {
...
<Image   source={{uri:GLOBAL.pimage}}
         ...
         <Image
             ...
             style={{width: 20, height:20, margin:14,resizeMode:'contain'}}
